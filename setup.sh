...
rm -f markers.fasta
echo "Building lastdb for Metaphlan2 markergene database"
...
echo "Building lastdb for SARG-nt database"
...
unzip ESCG.fna.zip
rm -f ESCG.fna.zip
echo "Building lastdb for ESCG database"
${DIR}/bin/last-983/src/lastdb -Q 0 ESCG.fna ESCG.fna -P 10


########## lineage database ###################################################################
echo "Downloading lineage information for NCBI taxonomy"
