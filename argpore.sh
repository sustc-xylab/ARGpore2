...
output files:
	input_arg.summary.tab	summary of ARGs subtyps within nanopore dataset
	input_arg.w.taxa.tab	ARGs-containing nanopore reads with taxonomy assignment and plausible plasmid identification
	input_arg.tab	nanopore reads with valid hit to ARGs 
...
mv ${Input_fa2}_arg.summary.tab ${out}
